...
import org.wpilib.hardware.hal.HAL; // HAL usage reporting is used for robot data but there's no actual data to report (nor do I know how to properly report it)
...
public class Drive extends Mechanism {
  ...
  public Drive(
    ...
    // HAL.reportUsage("RobotDrive", "idk");
